...
class AdminOrderDetailActivity : AppCompatActivity() {
    ...
    private fun initialModule() {
        ...
        retrofit = Retrofit.Builder()
            ...
            .baseUrl("http://10.51.40.156/tree_store/")
            .build()
    ...
    private fun setDataToView() {
        ...
        Glide
            .with(this)
            .load("http://10.51.40.156/tree_store/uploads/${mDataResult.picture}")
            .into(imageView)
    ...
    private fun showDocDialog() {
        ...
        Glide
            .with(this)
            .load("http://10.51.40.156/tree_store/uploads/${mDataResult.payment_picture}")
